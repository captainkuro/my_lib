<?php
// contoh pemakaian pChart
set_include_path(get_include_path() . PATH_SEPARATOR . dirname(dirname(__FILE__)).'/library2/pChart');
require_once 'pChart.class';
require_once 'pData.class';
